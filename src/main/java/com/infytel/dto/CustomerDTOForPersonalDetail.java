...
//this class is used to validate details provided for personal data validation
public class CustomerDTOForPersonalDetail {
	...
	@Size(min=1, max=15)
	@NotNull(message = "{first.last.name.not.present}")
	@NotBlank(message = "{first.last.name.not.present}")
	...
	public CustomerDTOForPersonalDetail() {
	}

	public CustomerDTOForPersonalDetail(Long uniqueIdNumber, LocalDate dateOfBirth, String emailAddress, String firstName,
